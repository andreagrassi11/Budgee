...
public class InsertTransactionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_insert_transaction, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        EditText editTextValue = view.findViewById(R.id.editTextText);
        EditText editTextName = view.findViewById(R.id.editTextText4);
